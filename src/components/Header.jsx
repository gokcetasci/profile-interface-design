...
function Header() {
    ...
    const toggleDropdown = () => {     //dropdown menüyü açma kapama
        setIsDropdownOpen(!isDropdownOpen);
    };

    const [isMenuOpen, setIsMenuOpen] = useState(false);  //hamburger memüyü açma kapama
    ...
    return (
        <div className='py-0 h-auto w-screen bg-white tracking-wide '>
            <div className='mx-auto md:mx-[74px] px-3 py-2.5  flex flex-row h-[60px] lg:h-[100px] items-center relative justify-between w-[1320px}'>
                ...
                <div className='text-[14px]	font-normal text-basecolor hidden lg:flex'>
                    <a href="" className='px-4 py-2'>Blog</a>
                    <a href="" className='px-4 py-2'>Hakkımızda</a>
                    <a href="" className='px-4 py-2'>İletişim</a>
                </div>
                <div id='dropdown' className='relative flex flex-row justify-center items-center h-[43px] mx-auto text-basecolor hidden lg:flex'>
                ...
                <div className='flex flex-row pr-[8px] mr-[48px] ml-auto  justify-center items-center hidden lg:flex'>
                    <a href="" className='flex flex-row'>
                        <svg width="18.85" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='mr-2'>
                ...
                <div className='flex flex-row justify-center align-items-center hidden lg:flex'>
                ...
                <div className='lg:hidden'>
                    <div className={`menu-toggle ${isMenuOpen ? 'open' : ''}`} onClick={toggleMenu}>
                        <RxHamburgerMenu className='w-[30px] h-[30px] text-gray-500'/>
                    </div>
                    {isMenuOpen && (
                        <div className='fixed top-0 left-0 w-full h-full flex place-content-end bg-black bg-opacity-50 z-30'>
                            <div className='bg-white w-[400px] '>
                                <div className="flex flex-row justify-between items-center p-4" onClick={closeMenu}>
                                    <p className='font-bold text-[20px]'>Menü</p>
                                    <MdClose className='text-primary/50 text-2xl hover:text-primary/75 cursor-pointer	' />
                                </div>
                                <ul className='p-4'>
                                    <li className='py-4 border-b'><a href="#" className='text-[13px] flex flex-row text-gray-500'>
                                        <AiOutlineUserAdd className='w-[18px] h-[18px] mr-[14px] text-pdicon'/>
                                        Kayıt ol
                                    </a></li>
                                    <li className='py-4 border-b'><a href="#" className='text-[13px] flex flex-row text-gray-500'>
                                        <RiUserFollowLine className='w-[18px] h-[18px] mr-[14px] text-pdicon'/>
                                        Giriş</a></li>
                                    <li className='py-4 border-b'><a href="#" className='text-[13px] flex flex-row '>
                                        ...
                                        <span className='ml-[14px] text-gray-500'>KURUMLAR</span>
                                    </a></li>
                                    <li className='py-4 border-b'><a href="#" className='text-[13px] flex flex-row text-gray-500'>
                                        <MdContentCopy className='w-[18px] h-[18px] mr-[14px] text-pdicon'/>
                                        Blog
                                    </a></li>
                                    <li className='py-4 border-b'><a href="#" className='text-[13px] flex flex-row text-gray-500'>
                                        <IoDocumentOutline className='w-[18px] h-[18px] mr-[14px] text-pdicon'/>
                                        Hakkımızda
                                    </a></li>
                                    <li className='py-4 border-b'><a href="#" className='text-[13px] flex flex-row text-gray-500'>
                                        <FiEdit className='w-[18px] h-[18px] mr-[14px] text-pdicon'/>
                                        Yardım
                                    </a></li>
                                    <li className='py-3 border-b'>
                                        <div id='dropdown' className='relative flex flex-row  items-center text-basecolor '>
                                        <button onClick={toggleDropdown} className=' flex flex-row  place-items-center '>
                                            <img src="https://www.livemedy.com/app/dist/img/flag/Tr.png" alt="" className='w-[30px] h-[30px] mr-3' />
                                            <p className='text-[13px] text-basecolor'>TR</p>
                                            <BiSolidDownArrow className='w-2 h-2 ml-[4px]' />
                                        </button>
                                        {isDropdownOpen && (
                                            <div className='dropdown-content absolute top-full left-0 border rounded-md	py-[5px] min-w-[92px] mt-[2px] z-10 bg-white text-[14px] flex flex-col'>
                                                <a href="#" className='flex flex-row items-center hover:bg-gray-100/50'>
                                                    <img src="https://www.livemedy.com/app/dist/img/flag/Tr.png" alt="" className='h-[33px] mr-4 pl-[5px]' />TR
                                                </a>
                                                <a href="#" className='flex flex-row items-center hover:bg-gray-100/50'>
                                                    <img src="https://www.livemedy.com/app/dist/img/flag/EN.png" alt="" className=' h-[33px] mr-4 pl-[5px]' />EN
