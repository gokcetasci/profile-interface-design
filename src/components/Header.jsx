    ...
    return (
        <div className='fixed-top py-0 h-[100px] w-screen bg-gray-100'>
            <div className='mx-[74px] px-3 py-2.5  flex flex-row h-[100px] items-center relative justify-between w-[1320px}'>
                ...
                <div className='flex flex-row pr-[8px] mr-[48px] ml-auto text-primary justify-center items-center'>
                    ...
                    <p className='text-[14px] font-medium'>KURUMLAR</p></a>
                </div>
                <div className='flex flex-row justify-center align-items-center '>
                    <a className='  flex  justify-center text-[16px]  items-center 
                    text-white rounded-0 rounded-start py-[8.5px] px-4 w-[90px]  bg-[#e74b3c] ml-[1px]  
                    font-normal  rounded-l-md hover:bg-[#eb6659]' href="">
                        Giriş
                    </a>
                    <a className=' flex  justify-center text-[16px]  items-center 
                    text-white rounded-0 rounded-start py-[8.5px] px-4 w-[90px] bg-[#e74b3c] ml-[1px]  
                    font-normal  rounded-r-md hover:bg-[#eb6659]' href="">
                        Üye Ol
                    </a>
                </div>
            </div>
